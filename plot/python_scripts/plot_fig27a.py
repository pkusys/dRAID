...
spdk_lat = []
draid_lat = []
draid_filenames = ['2.log','4.log','8.log','16.log','32.log','40.log','48.log','56.log','64.log','72.log','80.log','88.log','104.log','128.log']
spdk_filenames = ['4.log','8.log','12.log','16.log','24.log','32.log','40.log','48.log']
...
def _raid6_write():
    ...
    ax.set_ylabel('Avg Latency (us)', fontsize=15)
    ax.set_xlabel('Bandwidth (MB/s)', fontsize=15)
    ...
    plt.xticks(ticks=[0,2000,4000,6000,8000,10000], labels=[0,2000,4000,6000,8000,10000])
    plt.savefig('plots/fig27a.pdf', bbox_inches='tight', pad_inches=0.2)
