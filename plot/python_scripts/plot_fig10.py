...
io_size = [4,8,16,32,64,128,256,512,1024,2048,3584]
filenames = ['4K.log','8K.log','16K.log','32K.log','64K.log','128K.log','256K.log','512K.log','1024K.log','2048K.log','3584K.log']
...
def _raid5_write_bw():
    ...
    ax.set_xlabel('I/O Size (KB)', fontsize=17)
    ...
    plt.savefig('plots/fig10a.pdf', bbox_inches='tight', pad_inches=0.2)
...
def _raid5_write_lat():
    ...
    plt.xticks(ticks=[4,512,1024,2048,3584], labels=[4,512,1024,2048,3584])
    plt.savefig('plots/fig10b.pdf', bbox_inches='tight', pad_inches=0.2)
