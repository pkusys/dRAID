...
def _raid6_write_bw():
    ...
    ax.set_xlabel('Stripe Width', fontsize=15)
    ...
    plt.savefig('plots/fig25a.pdf', bbox_inches='tight', pad_inches=0.2)
...
def _raid6_write_lat():
    ...
    plt.savefig('plots/fig25b.pdf', bbox_inches='tight', pad_inches=0.2)
