...
draid_lat_rw = []
draid_bw_rw = []
draid_filenames = ['2.log','4.log','8.log','16.log','32.log','48.log','64.log','96.log','128.log','168.log']
spdk_filenames = ['4.log','8.log','12.log','16.log','24.log','32.log','36.log','42.log','48.log','60.log']
...
def _raid6_readwrite():
    ...
    ax.plot(linux_bw_rw, linux_lat_rw, linewidth=4, color='tab:blue', linestyle='solid', label='Linux', marker="o",
            markersize=ms, alpha=0.8)

    ax.plot(spdk_bw_rw, spdk_lat_rw, linewidth=4, color='tab:orange', linestyle='solid', label='SPDK',
            marker="^", markersize=ms, alpha=0.8)

    ax.plot(draid_bw_rw, draid_lat_rw, linewidth=4, color='tab:green', linestyle='solid', label='dRAID',
            marker="s", markersize=ms, alpha=0.8)

    ax.set_ylabel('Avg Latency (us)', fontsize=16)
    ax.set_xlabel('Bandwidth (MB/s)', fontsize=16)
    ...
    plt.xticks(ticks=[0,4000,8000,12000,16000], labels=[0,4000,8000,12000,16000])
    plt.savefig('plots/fig27b.pdf', bbox_inches='tight', pad_inches=0.2)
