...
io_size = [4,8,16,32,64,128,256,512,1024,2048,3072]
filenames = ['4K.log','8K.log','16K.log','32K.log','64K.log','128K.log','256K.log','512K.log','1024K.log','2048K.log','3072K.log']
...
def _raid6_write_bw():
    ...
    ax.set_ylabel('Bandwidth (MB/s)', fontsize=15)
    ax.set_xlabel('I/O Size (KB)', fontsize=15)
    ...
    plt.savefig('plots/fig23a.pdf', bbox_inches='tight', pad_inches=0.2)

def _raid6_write_lat():
    plt.clf()
    ...
    ax.set_ylabel('Avg Latency (us)', fontsize=15, labelpad=15)
    ax.set_xlabel('I/O Size (KB)', fontsize=15)
    ...
    plt.xticks(ticks=[4,512,1024,2048,3072], labels=[4,512,1024,2048,3072])
    plt.savefig('plots/fig23b.pdf', bbox_inches='tight', pad_inches=0.2)
