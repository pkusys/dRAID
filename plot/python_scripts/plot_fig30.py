...
def _raid6_write_bw():
    ...
    ax.set_xlabel('I/O Size (KB)', fontsize=25)

    plt.savefig('plots/fig30a.pdf', bbox_inches='tight', pad_inches=0.2)
...
def _raid6_write_lat():
    ...
    ax.set_xlabel('I/O Size (KB)', fontsize=29,labelpad=20)
    ...
    plt.xticks(ticks=[4,32,64,128], labels=[4,32,64,128])
    plt.savefig('plots/fig30b.pdf', bbox_inches='tight', pad_inches=0.2)
