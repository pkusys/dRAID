...
def _raid5_app(spdk, draid, path):
    ...
    plt.xticks(fontsize=29, rotation = 30)
    ...
    if '-d' in path:
        ...
        ax.set_ylim([0, 500])
    adapt_y_labels(ax, '{: >3}')
    ax.set_ylabel('Throughput (KIOPS)', fontsize=29)
...
if not os.path.exists('plots'):
    os.makedirs('plots')
_raid5_app(spdk_iops,draid_iops,'plots/fig19a.pdf')
