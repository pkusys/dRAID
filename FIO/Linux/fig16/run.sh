...
then
  ...
  sudo fio --filename=/dev/md0 --size=8196M --time_based --runtime=15s --ramp_time=2s --ioengine=libaio --direct=1 --verify=0 --group_reporting=1 --name=randwrite --rw=randread --rwmixread=0 --bs=128K --iodepth=6 --numjobs=1
