...
then
  ...
  sudo fio --filename=/dev/md0 --size=8196M --numjobs=1 --time_based --runtime=15s --ramp_time=2s --ioengine=libaio --direct=1 --verify=0 --rw=randwrite --group_reporting=1 --name=randwrite --bs=128K --iodepth=6 > results/${stripe_width}.log
...
then
  ...
  sudo fio --filename=/dev/md0 --size=8196M --numjobs=1 --time_based --runtime=15s --ramp_time=2s --ioengine=libaio --direct=1 --verify=0 --rw=randwrite --group_reporting=1 --name=randwrite --bs=128K --iodepth=7 > results/${stripe_width}.log
...
then
  ...
  sudo fio --filename=/dev/md0 --size=8196M --time_based --runtime=15s --ramp_time=2s --ioengine=libaio --direct=1 --verify=0 --rw=randwrite --group_reporting=1 --name=randwrite --bs=128K --iodepth=8 --numjobs=1 > results/${stripe_width}.log
...
then
  ...
  sudo fio --filename=/dev/md0 --size=8196M --time_based --runtime=15s --ramp_time=2s --ioengine=libaio --direct=1 --verify=0 --group_reporting=1 --name=randwrite --rw=randwrite --bs=128K --iodepth=8 --numjobs=1 > results/${stripe_width}.log
