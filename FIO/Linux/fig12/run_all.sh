...
sudo fio --filename=/dev/md0 --size=8196M --numjobs=1 --time_based --runtime=15s --ramp_time=2s --ioengine=libaio --direct=1 --verify=0 --rw=randwrite --group_reporting=1 --name=randwrite --bs=128K --iodepth=6 > results/4.log
cleanup
stripe_width=6
echo "generating results on stripe width $stripe_width"
...
sudo fio --filename=/dev/md0 --size=8196M --numjobs=1 --time_based --runtime=15s --ramp_time=2s --ioengine=libaio --direct=1 --verify=0 --rw=randwrite --group_reporting=1 --name=randwrite --bs=128K --iodepth=6 > results/6.log
cleanup
stripe_width=8
echo "generating results on stripe width $stripe_width"
...
sudo fio --filename=/dev/md0 --size=8196M --numjobs=1 --time_based --runtime=15s --ramp_time=2s --ioengine=libaio --direct=1 --verify=0 --rw=randwrite --group_reporting=1 --name=randwrite --bs=128K --iodepth=7 > results/8.log
cleanup
stripe_width=10
echo "generating results on stripe width $stripe_width"
...
sudo fio --filename=/dev/md0 --size=8196M --time_based --runtime=15s --ramp_time=2s --ioengine=libaio --direct=1 --verify=0 --rw=randwrite --group_reporting=1 --name=randwrite --bs=128K --iodepth=8 --numjobs=1 > results/10.log
cleanup
stripe_width=12
echo "generating results on stripe width $stripe_width"
