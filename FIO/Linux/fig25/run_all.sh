...
sudo fio --filename=/dev/md0 --size=8196M --time_based --runtime=15s --ramp_time=2s --ioengine=libaio --direct=1 --verify=0 --group_reporting=1 --name=randwrite --rw=randwrite --bs=128K --iodepth=6 --numjobs=1 > results/4.log
cleanup
stripe_width=6
echo "generating results on stripe width $stripe_width"
...
sudo fio --filename=/dev/md0 --size=8196M --time_based --runtime=15s --ramp_time=2s --ioengine=libaio --direct=1 --verify=0 --group_reporting=1 --name=randwrite --rw=randwrite --bs=128K --iodepth=7 --numjobs=1 > results/6.log
cleanup
stripe_width=8
echo "generating results on stripe width $stripe_width"
...
sudo fio --filename=/dev/md0 --size=8196M --time_based --runtime=15s --ramp_time=2s --ioengine=libaio --direct=1 --verify=0 --group_reporting=1 --name=randwrite --rw=randwrite --bs=128K --iodepth=8 --numjobs=1 > results/8.log
cleanup
stripe_width=10
echo "generating results on stripe width $stripe_width"
...
sudo fio --filename=/dev/md0 --size=8196M --time_based --runtime=15s --ramp_time=2s --ioengine=libaio --direct=1 --verify=0 --group_reporting=1 --name=randwrite --rw=randwrite --bs=128K --iodepth=8 --numjobs=1 > results/10.log
cleanup
stripe_width=12
echo "generating results on stripe width $stripe_width"
...
sudo fio --filename=/dev/md0 --size=8196M --time_based --runtime=15s --ramp_time=2s --ioengine=libaio --direct=1 --verify=0 --group_reporting=1 --name=randwrite --rw=randwrite --bs=128K --iodepth=8 --numjobs=1 > results/12.log
cleanup
stripe_width=14
echo "generating results on stripe width $stripe_width"
...
sudo fio --filename=/dev/md0 --size=8196M --time_based --runtime=15s --ramp_time=2s --ioengine=libaio --direct=1 --verify=0 --group_reporting=1 --name=randwrite --rw=randwrite --bs=128K --iodepth=8 --numjobs=1 > results/14.log
cleanup
stripe_width=16
echo "generating results on stripe width $stripe_width"
...
sudo fio --filename=/dev/md0 --size=8196M --time_based --runtime=15s --ramp_time=2s --ioengine=libaio --direct=1 --verify=0 --group_reporting=1 --name=randwrite --rw=randwrite --bs=128K --iodepth=8 --numjobs=1 > results/16.log
cleanup
stripe_width=18
echo "generating results on stripe width $stripe_width"
...
sudo fio --filename=/dev/md0 --size=8196M --time_based --runtime=15s --ramp_time=2s --ioengine=libaio --direct=1 --verify=0 --group_reporting=1 --name=randwrite --rw=randwrite --bs=128K --iodepth=8 --numjobs=1 > results/18.log
cleanup
