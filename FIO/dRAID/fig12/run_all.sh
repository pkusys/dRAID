...
then
  ...
  sleep 3
  sudo timeout -k 5 60 LD_PRELOAD=../spdk_bdev /usr/local/bin/fio ../raid5.conf -ioengine=../spdk_bdev -iodepth=8 -rw=randwrite -bs=128k -numjobs=2 > results/4.log
fi
...
then
  ...
  sleep 4
  sudo timeout -k 5 80 LD_PRELOAD=../spdk_bdev /usr/local/bin/fio ../raid5.conf -ioengine=../spdk_bdev -iodepth=12 -rw=randwrite -bs=128k -numjobs=2 > results/6.log
fi
...
then
  ...
  sleep 5
  sudo timeout -k 5 100 LD_PRELOAD=../spdk_bdev /usr/local/bin/fio ../raid5.conf -ioengine=../spdk_bdev -iodepth=17 -rw=randwrite -bs=128k -numjobs=2 > results/8.log
fi
...
then
  ...
  sleep 6
  sudo timeout -k 5 120 LD_PRELOAD=../spdk_bdev /usr/local/bin/fio ../raid5.conf -ioengine=../spdk_bdev -iodepth=20 -rw=randwrite -bs=128k -numjobs=2 > results/10.log
fi
...
then
  ...
  sleep 7
  sudo timeout -k 5 140 LD_PRELOAD=../spdk_bdev /usr/local/bin/fio ../raid5.conf -ioengine=../spdk_bdev -iodepth=24 -rw=randwrite -bs=128k -numjobs=2 > results/12.log
fi
...
then
  ...
  sleep 8
  sudo timeout -k 5 160 LD_PRELOAD=../spdk_bdev /usr/local/bin/fio ../raid5.conf -ioengine=../spdk_bdev -iodepth=28 -rw=randwrite -bs=128k -numjobs=2 > results/14.log
fi
...
then
  ...
  sleep 9
  sudo timeout -k 5 180 LD_PRELOAD=../spdk_bdev /usr/local/bin/fio ../raid5.conf -ioengine=../spdk_bdev -iodepth=32 -rw=randwrite -bs=128k -numjobs=2 > results/16.log
fi
...
then
  ...
  sleep 10
  sudo timeout -k 5 200 LD_PRELOAD=../spdk_bdev /usr/local/bin/fio ../raid5.conf -ioengine=../spdk_bdev -iodepth=36 -rw=randwrite -bs=128k -numjobs=2 > results/18.log
fi
